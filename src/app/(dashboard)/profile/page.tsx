...
type TabKey = "personal" | "security" | "achievements"
...
function ProfileSkeleton() {
  return (
    <div className="space-y-8">
      ...
      <Sk className="h-10 w-96 rounded-xl" />
...
export default function ProfilePage() {
  ...
  const TABS: { key: TabKey; label: string }[] = [
    { key: "personal",     label: t("profile.personalInfo") },
      ...
      <div className="flex gap-6 border-b border-slate-200 dark:border-slate-800 overflow-x-auto">
        {TABS.map(tab => (
          <button
            ...
            className={`pb-3 text-sm font-bold whitespace-nowrap transition-all border-b-2 -mb-px ${
              activeTab === tab.key
